...
<html
  ...
  <head>
    ...
    <title>Under Maintenance - Pages | Materio - Bootstrap Material Design Admin Template</title>
      ...
      <div class="d-flex justify-content-center mt-5">
        ...
        <div class="d-flex flex-column align-items-center">
          <img
            ...
            width="780" />
          <div>
            <a href="index.html" class="btn btn-primary text-center my-5">Back to home</a>
          </div>
        </div>
      </div>
    </div>
