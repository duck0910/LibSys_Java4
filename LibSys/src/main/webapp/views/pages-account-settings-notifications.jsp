        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Account Settings /</span> Notifications</h4>
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <span
                        ...
                        <a href="javascript:void(0);" class="notificationRequest">Request Permission</a></span
                      >
                      <div class="error"></div>
                    </div>
                    ...
                    <div class="card-body">
                      <h6 class="mb-4">When should we send you notifications?</h6>
