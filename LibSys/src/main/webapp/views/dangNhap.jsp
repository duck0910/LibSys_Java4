...
<!-- Core CSS -->
<link rel="stylesheet"
	href="${url1 }views/static/assets/vendor/css/core.css"
...
<body>
						...
						<div class="col-md-6">
							<div class="card">
								<div class="card-body">
									...
									<form action="${url}dnhap" method="post">
										<div class="mb-3">
	...
	<script
		src="${url1 }views/static/assets/vendor/libs/node-waves/node-waves.js"></script>
	<script
	...
	<!-- Vendors JS -->
	<script
		src="${url1 }views/static/assets/vendor/libs/apex-charts/apexcharts.js"></script>
